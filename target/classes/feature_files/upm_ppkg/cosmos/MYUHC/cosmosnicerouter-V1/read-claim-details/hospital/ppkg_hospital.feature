Feature: Request Cosmos OBAPI PayerPackage PROD Hospital Details
  ...
  Scenario Outline: Get PayerPackage Hospital Details
    ...
    * karate.write(response, filename)
    Examples:
      | read('classpath:testdata/upm_ppkg_cosmos/MYUHC/cosmosnicerouter-V1/details/hospital_TestData.csv') |
