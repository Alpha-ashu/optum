Feature: Request Cosmos ACET PPKG PROD read claim Details
  ...
  Scenario Outline: Request for PPKG Physician claim details validation
    ...
    * def perfData = { consumer: 'ACET', feature: 'ppkg_physician', scenario: 'Request for PPKG Physician claim details validatio', endpoint: '#(karate.info.scenarioName)', method: 'GET', status: '#(responseStatus)', responseTimeMs: '#(responseTime)' }
