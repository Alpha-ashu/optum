Feature: ALEX Claim Service Pricing GraphQL API Test
  ...
  Scenario Outline: Send GraphQL request for Claim Service Pricing
    ...
    * def perfData = { consumer: 'ALEX', feature: 'mes_claimServicePricing', scenario: 'Send GraphQL request for Claim Service Pricing', endpoint: '#(karate.info.scenarioName)', method: 'POST', status: '#(responseStatus)', responseTimeMs: '#(responseTime)' }
