Feature: HCP Claim Pricing GraphQL API Test
  ...
  Scenario Outline: Send GraphQL request for Claim Pricing
    ...
    * def perfData = { consumer: 'ALEX', feature: 'hcp_claimPricing', scenario: 'Send GraphQL request for Claim Pricing', endpoint: '#(karate.info.scenarioName)', method: 'POST', status: '#(responseStatus)', responseTimeMs: '#(responseTime)' }
