Feature: ALEX Claim Service line GraphQL API Test
  ...
  Scenario Outline: Send GraphQL request for Claim Service line
    ...
    * def perfData = { consumer: 'ALEX', feature: 'mes_claimAggregates', scenario: 'Send GraphQL request for Claim Service line', endpoint: '#(karate.info.scenarioName)', method: 'POST', status: '#(responseStatus)', responseTimeMs: '#(responseTime)' }
