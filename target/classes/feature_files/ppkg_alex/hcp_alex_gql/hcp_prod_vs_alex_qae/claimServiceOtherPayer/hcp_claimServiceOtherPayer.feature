Feature: HCP Claim Service Other Payer GraphQL API Test
  ...
  Scenario Outline: Send GraphQL request for Claim Service Other Payer
    ...
    * def perfData = { consumer: 'ALEX', feature: 'hcp_claimServiceOtherPayer', scenario: 'Send GraphQL request for Claim Service Other Payer', endpoint: '#(karate.info.scenarioName)', method: 'POST', status: '#(responseStatus)', responseTimeMs: '#(responseTime)' }
