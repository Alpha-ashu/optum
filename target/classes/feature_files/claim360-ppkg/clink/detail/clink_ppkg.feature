        ...
        """
{
    ...
    * karate.write(response, 'All_Responses/Hospital/PPKG_Responses/' + testcase + '_' + reqClmNbr + '_ppkg.json')
    * print('********************', testcase, reqTin, '[COMPLETED] ******************************')

    Examples:
      | read('classpath:testdata/clink/clink_payer_hospital_testdata.csv') |
