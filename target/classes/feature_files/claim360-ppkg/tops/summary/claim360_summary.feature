Feature: Request Cosmos PayerPackage Non-prod Summary
  ...
  Scenario Outline:
    ...
    * def filename = 'All_Responses/Claim360/UPM_Responses/Summary/' + testcase + '_' + ICN + '_upm.json'
    * def perfData = { consumer: 'COSMOS', feature: 'claim360_summary', scenario: 'Claim360 summary request validation', endpoint: '#(karate.info.scenarioName)', method: 'POST', status: '#(responseStatus)', responseTimeMs: '#(responseTime)' }
