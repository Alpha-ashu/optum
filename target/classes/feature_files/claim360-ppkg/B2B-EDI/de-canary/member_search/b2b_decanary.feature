...
"""
  ...
  Scenario Outline: Claims 360 B2B Member Search
    ...
    * def filename = 'All_Responses/Claim360/B2B/Member_Search/Decanary_Responses/' + testcase + '_' + reqSbmtProvId + '_decan.json'
    * def perfData = { consumer: 'CLAIMS360', feature: 'b2b_member_search_decanary', scenario: 'Claim360 B2B de-canary member search request validation', endpoint: '#(karate.info.scenarioName)', method: 'POST', status: '#(responseStatus)', responseTimeMs: '#(responseTime)' }
