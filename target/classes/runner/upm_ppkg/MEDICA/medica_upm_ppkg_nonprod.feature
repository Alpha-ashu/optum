Feature:  UPM - PPKG MEDICA COSMOS for NON-PROD ENVIRONMENT

  Background:
    # Base response folders
    * def upmBase = 'target/All_Responses/MEDICA/UPM_Responses'
    * def ppkgBase = 'target/All_Responses/MEDICA/PPKG_Responses'
  ...
  Scenario: 1. callonceing the Cosmos MEDICA Claim Search
    * print('******************** [MEDICA Claim Search][COSMOS][NON-PROD][STARTED] ********************')
    * def Var = 'MEDICA_Summary'
    * print('[CLEANUP] Response folders cleaned - fresh start for:', Var)
    * print('******************** [UPM SUMMARY][STARTED] *****************************************')
    * def callonceUpm = callonce read('classpath:feature_files/upm_ppkg/cosmos/MEDICA/summary/upm_summary.feature')
    * print('******************** [UPM SUMMARY][COMPLETED] ***************************************')
    * print('******************** [PPKG SUMMARY][STARTED] ****************************************')
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/MEDICA/non-prod/ppkg_nonprod_summary.feature')
    * print('******************** [PPKG SUMMARY][COMPLETED] **************************************')
    * print('******************** [MEDICA Claim Search][COSMOS][NON-PROD][COMPLETED] ******************')
