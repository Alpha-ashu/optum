Feature: UPM - PPKG MYUHC COSMOS for NON-PROD ENVIRONMENT V2
  ...
  Scenario: 1. callonceing the Cosmos MYUHC V2 Summary
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnice-V2/non-prod/ppkg_nonprod_summary.feature')
  ...
  Scenario: 2. callonceing the Cosmos MYUHC V2 Details Hospital
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnice-V2/non-prod/ppkg_nonprod_hospital.feature')
  ...
  Scenario: 3. callonceing the Cosmos MYUHC V2 Details Physician
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnice-V2/non-prod/ppkg_nonprod_physician.feature')
    * print('******************** [PPKG DETAILS] [HOSPITAL] [COMPLETED]******************************')
