Feature: UPM - PPKG MYUHC COSMOS for PROD ENVIRONMENT V1
  ...
  Scenario: 1. callonceing the Cosmos MYUHC V1 Summary
    * print('******************** [MYUHC V1 Summary][COSMOS][PROD][STARTED] **********************')
    * def Var = 'MYUHC_Summary_V1'
    * print('[CLEANUP] Response folders cleaned - fresh start for:', Var)
    * print('******************** [UPM SUMMARY][STARTED] *****************************************')
    * def callonceUpm = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnicerouter-V1/summary/upm_summary.feature')
    * print('******************** [UPM SUMMARY][COMPLETED] ***************************************')
    * print('******************** [PPKG SUMMARY][STARTED] ****************************************')
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnicerouter-V1/summary/ppkg_summary.feature')
    * print('******************** [PPKG SUMMARY][COMPLETED] **************************************')
    * print('******************** [MYUHC V1 Summary][COSMOS][PROD][COMPLETED] *********************')
    # --- Validation and Report Generation ---
    * eval runValidation(Var)
    * print('[DONE] Scenario completed, validated, and cleaned:', Var)

  Scenario: 2. callonceing the Cosmos MYUHC V1 Details Hospital
    * print('******************** [MYUHC V1 DETAILS][COSMOS][PROD][STARTED] *************************')
    * def Var = 'MYUHC_Hospital_V1'
    * print('[CLEANUP] Response folders cleaned - fresh start for:', Var)
    * print('******************** [UPM DETAILS] [HOSPITAL] [STARTED] ********************************')
    * def callonceUpm = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnicerouter-V1/read-claim-details/hospital/upm_hospital.feature')
    * print('******************** [UPM DETAILS] [HOSPITAL][COMPLETED] *******************************')
    * print('******************** [PPKG DETAILS] [HOSPITAL] [STARTED] *******************************')
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnicerouter-V1/read-claim-details/hospital/ppkg_hospital.feature')
    * print('******************** [PPKG DETAILS] [HOSPITAL] [COMPLETED]******************************')
    * print('******************** [MYUHC V1 DETAILS][COSMOS] [PROD][COMPLETED] **********************')
    # --- Validation and Report Generation ---
    * eval runValidation(Var)
    * print('[DONE] Scenario completed, validated, and cleaned:', Var)

  Scenario: 3. callonceing the Cosmos MYUHC V1 Details Physician
    * print('******************** [MYUHC DETAILS] [COSMOS] [PROD][STARTED] **************************')
    * def Var = 'MYUHC_Physician_V1'
    * print('[CLEANUP] Response folders cleaned - fresh start for:', Var)
    * print('******************** [UPM DETAILS] [PHYSICIAN] [STARTED] *******************************')
    * def callonceUpm = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnicerouter-V1/read-claim-details/physician/upm_physician.feature')
    * print('******************** [UPM DETAILS] [PHYSICIAN][COMPLETED] ******************************')
    * print('******************** [PPKG DETAILS] [PHYSICIAN] [STARTED] ******************************')
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnicerouter-V1/read-claim-details/physician/ppkg_physician.feature')
    * print('******************** [PPKG DETAILS] [HOSPITAL] [COMPLETED]******************************')
    * print('******************** [MYUHC V1 DETAILS][COSMOS] [PROD][COMPLETED] **********************')
    # --- Validation and Report Generation ---
    * eval runValidation(Var)
