Feature:  UPM - PPKG VETSS COSMOS for NON-PROD ENVIRONMENT Summary and Details
  ...
  Scenario: 1. callonceing the Cosmos VETSS Claim Search
    * print('******************** [VETSS Claim Search][COSMOS][NON-PROD][STARTED] ********************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/VETSS/non-prod/ppkg_nonprod_summary.feature')
    * print('******************** [PPKG SUMMARY][COMPLETED] **************************************')
    * print('******************** [VETSS Claim Search][COSMOS][NON-PROD][COMPLETED] ******************')
  ...
  Scenario: 2. callonceing the Cosmos VETSS Claim read HOSPITAL
    * print('******************** [VETSS Claim HOSPITAL][COSMOS][NON-PROD][STARTED] ********************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/VETSS/non-prod/ppkg_nonprod_hospital.feature')
    * print('******************** [PPKG HOSPITAL][COMPLETED] **************************************')
    * print('******************** [VETSS Claim HOSPITAL][COSMOS][NON-PROD][COMPLETED] ******************')
    # --- Validation and Report Generation ---
    * eval runValidation(Var)
    * print('[DONE] Scenario completed, validated, and cleaned:', Var)

  Scenario: 3. callonceing the Cosmos VETSS Claim read PHYSICIAN
    * print('******************** [VETSS Claim PHYSICIAN][COSMOS][NON-PROD][STARTED] ********************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/VETSS/non-prod/ppkg_nonprod_physician.feature')
    * print('******************** [PPKG PHYSICIAN][COMPLETED] **************************************')
    * print('******************** [VETSS Claim PHYSICIAN][COSMOS][NON-PROD][COMPLETED] ******************')
    # --- Validation and Report Generation ---
    * eval runValidation(Var)
    * print('[DONE] Scenario completed, validated, and cleaned:', Var)
