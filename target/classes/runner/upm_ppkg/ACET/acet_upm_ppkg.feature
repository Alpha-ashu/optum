Feature:  UPM - PPKG ACET COSMOS for NON-PROD ENVIRONMENT
  ...
  Scenario: 1. callonceing the Cosmos ACET Summary Claim Search
    * print('******************** [ACET Claim Search] [COSMOS] [PROD] [STARTED] *********************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/ACET/summary/ppkg_summary.feature')
    * print('******************** [PPKG SUMMARY][COMPLETED] ****************************************')
    * print('******************** [ACET Claim Search] [COSMOS] [PROD] [COMPLETED] *******************')
  ...
  Scenario: 2. callonceing the Cosmos ACET Claim Details Hospital
    * print('******************** [ACET DETAILS] [COSMOS] [PROD][STARTED] ****************************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/ACET/read-claim-details/hospital/ppkg_hospital.feature')
    * print('******************** [PPKG DETAILS] [HOSPITAL] [COMPLETED]******************************')
    * print('******************** [ACET DETAILS] [COSMOS] [PROD] [COMPLETED] *************************')
    # --- Validation and Report Generation ---
    * eval runValidation(Var)
    * print('[DONE] Scenario completed, validated, and cleaned:', Var)
  ...
  Scenario: 3. callonceing the Cosmos ACET Claim Details Physician
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/ACET/read-claim-details/physician/ppkg_physician.feature')
