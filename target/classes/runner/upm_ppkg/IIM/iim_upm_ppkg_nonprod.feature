Feature: UPM - PPKG ALEXTRO COSMOS for NON-PROD ENVIRONMENT
  ...
  Scenario: 1. callonceing the Cosmos UPM / Maestro Summary
    * print('******************** [IIM DETAILS] [COSMOS] [NON-PROD][STARTED]**********************')
    * def Var = 'IIM_Summary'
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/IIM/non-prod/ppkg_nonprod_summary.feature')
    * print('******************** [PPKG SUMMARY][COMPLETED] **************************************')
    * print('******************** [IIM DETAILS] [COSMOS] [NON-PROD][COMPLETED] *******************')
    # --- Validation and Report Generation ---
    * eval runValidation(Var)
    * print('[DONE] Scenario completed, validated, and cleaned:', Var)

  Scenario: 2. callonceing the Cosmos UPM / Maestro Details Hospital
    * print('******************** [IIM DETAILS] [COSMOS] [NON-PROD][STARTED]*************************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/IIM/non-prod/ppkg_nonprod_hospital.feature')
  ...
  Scenario: 3. callonceing the Cosmos UPM / Maestro Details Physician
    * print('******************** [IIM DETAILS] [COSMOS] [NON-PROD][STARTED] ************************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/IIM/non-prod/ppkg_nonprod_physician.feature')
