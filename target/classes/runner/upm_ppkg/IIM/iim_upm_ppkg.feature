Feature:  UPM - PPKG ALEXTRO COSMOS for PROD ENVIRONMENT
  ...
  Scenario: 1. callonceing the Cosmos IIM Claim Search
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/IIM/summary/ppkg_summary.feature')
  ...
  Scenario: 2. callonceing the Cosmos IIM Claim Details Hospital
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/IIM/read-claim-details/hospital/ppkg_hospital.feature')
  ...
  Scenario: 3. callonceing the Cosmos IIM Claim Details Physician
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/IIM/read-claim-details/physician/ppkg_physician.feature')
