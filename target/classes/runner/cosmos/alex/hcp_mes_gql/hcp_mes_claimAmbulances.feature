Feature:  HCP GQL - ALEX Claimserviceline
  ...
  Scenario: 1. Comparing the Cosmos HCP and ALEX Claim Details
    ...
    * def callonceHCP = callonce read('classpath:feature_files/ppkg_alex/hcp_mes_gql/claimAmbulance/hcp_claimAmbulance.feature')
    * print('******************** [PPKG Physician][COMPLETED] ****************************************')
    * print('******************** [ALEX Physician][STARTED] *******************************************')
    * def callonceALEX = callonce read('classpath:feature_files/ppkg_alex/hcp_mes_gql/claimAmbulance/mes_claimAmbulance.feature')
