Feature:  UPM - PPKG MEDICA COSMOS for PROD ENVIRONMENT
  ...
  Scenario: 1. callonceing the Cosmos MEDICA Claim Search
    * print('******************** [MEDICA Claim Search][COSMOS][PROD][STARTED] ********************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/MEDICA/summary/ppkg_summary.feature')
    * print('******************** [PPKG SUMMARY][COMPLETED] **************************************')
    * print('******************** [MEDICA Claim Search][COSMOS][PROD][COMPLETED] ******************')
