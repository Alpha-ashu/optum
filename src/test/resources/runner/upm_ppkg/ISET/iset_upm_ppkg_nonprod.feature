Feature:  UPM - PPKG ISET COSMOS for NON-PROD ENVIRONMENT V2
  ...
  Scenario: 1. ISET COSMOS PROD ENVIRONMENT Summary
    * print('******************** [ISET Claim Search] [COSMOS] [NON-PROD] [STARTED] *********************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/ISET/non-prod/ppkg_nonprod_summary.feature')
    * print('******************** [PPKG SUMMARY][COMPLETED] ****************************************')
    * print('******************** [IIM Claim Search] [COSMOS] [NON-PROD] [COMPLETED] *******************')
  ...
  Scenario: 2. ISET COSMOS PROD ENVIRONMENT HOSPITAL
    * print('******************** [ISET HOSPITAL] [COSMOS] [NON-PROD] [STARTED] *********************')
    ...
    * print('******************** [UPM SUMMARY][COMPLETED] *****************************************')
    * print('******************** [PPKG SUMMARY][STARTED] ******************************************')
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/ISET/non-prod/ppkg_nonprod_hospital.feature')
    * print('******************** [PPKG SUMMARY][COMPLETED] ****************************************')
    * print('******************** [IIM HOSPITAL] [COSMOS] [NON-PROD] [COMPLETED] *******************')
    # --- Validation and Report Generation ---
    * eval runValidation(Var)
    * print('[DONE] Scenario completed, validated, and cleaned:', Var)

  Scenario: 3. ISET COSMOS PROD ENVIRONMENT PHYSICIAN
    * print('******************** [ISET PHYSICIAN] [COSMOS] [NON-PROD] [STARTED] *********************')
    ...
    * print('******************** [UPM SUMMARY][COMPLETED] *****************************************')
    * print('******************** [PPKG SUMMARY][STARTED] ******************************************')
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/ISET/non-prod/ppkg_nonprod_physician.feature')
    * print('******************** [PPKG SUMMARY][COMPLETED] ****************************************')
    * print('******************** [IIM PHYSICIAN] [COSMOS] [NON-PROD] [COMPLETED] *******************')
    # --- Validation and Report Generation ---
    * eval runValidation(Var)
    * print('[DONE] Scenario completed, validated, and cleaned:', Var)
