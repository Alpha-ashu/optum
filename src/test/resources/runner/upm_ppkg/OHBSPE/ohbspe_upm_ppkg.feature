Feature: UPM - PPKG OHSPE COSMOS PROD ENVIRONMENT Summary and Details
  ...
  Scenario: 1. callonceing the Cosmos OHBSPE Claim Search
    * print('******************** [OHBSPE Claim Search] [COSMOS] [PROD] [STARTED] *********************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/OHBSPE/summary/ppkg_summary.feature')
    * print('******************** [PPKG SUMMARY][COMPLETED] ****************************************')
    * print('******************** [OHBSPE Claim Search] [COSMOS] [PROD] [COMPLETED] *******************')
  ...
  Scenario: 2. callonceing the Cosmos OHBSPE Claim Details Physician
    * print('******************** [OHBSPE DETAILS] [COSMOS] [PROD][STARTED] *****************************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/OHBSPE/read-claim-details/ppkg_physician.feature')
    * print('******************** [PPKG DETAILS] [PHYSICIAN] [COMPLETED]******************************')
    * print('******************** [OHBSPE DETAILS] [COSMOS] [PROD] [COMPLETED] **************************')
    # --- Validation and Report Generation ---
    * eval runValidation(Var)
    * print('[DONE] Scenario completed, validated, and cleaned:', Var)
