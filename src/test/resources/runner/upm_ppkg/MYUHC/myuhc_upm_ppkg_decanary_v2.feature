Feature: UPM - PPKG MYUHC COSMOS for Decanary ENVIRONMENT V2
  ...
  Scenario: 1. callonceing the Cosmos MYUHC V2 Summary
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnice-V2/decanary/ppkg_summary.feature')
  ...
  Scenario: 2. callonceing the Cosmos MYUHC V2 Details Hospital
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnice-V2/decanary/ppkg_hospital.feature')
  ...
  Scenario: 3. callonceing the Cosmos MYUHC V2 Details Physician
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/MYUHC/cosmosnice-V2/decanary/ppkg_physician.feature')
    * print('******************** [PPKG DETAILS] [HOSPITAL] [COMPLETED]******************************')
