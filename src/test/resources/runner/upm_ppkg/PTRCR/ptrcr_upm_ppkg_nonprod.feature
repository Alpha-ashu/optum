Feature:  UPM - PPKG PTRCR COSMOS for NON-PROD ENVIRONMENT Summary and Details
  ...
  Scenario: 1. callonceing the Cosmos PTRCR Claim Search
    * print('******************** [PTRCR Claim Search] [COSMOS] [NON-PROD] [STARTED] *********************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/PTRCR/non-prod/ppkg_nonprod_summary.feature')
    * print('******************** [PPKG SUMMARY][COMPLETED] ****************************************')
    * print('******************** [PTRCR Claim Search] [COSMOS] [NON-PROD] [COMPLETED] *******************')
  ...
  Scenario: 2. callonceing the Cosmos PTRCR Claim Details Hospital
    * print('******************** [PTRCR DETAILS] [COSMOS] [NON-PROD][STARTED] ****************************')
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/PTRCR/non-prod/ppkg_nonprod_hospital.feature')
    * print('******************** [PPKG DETAILS] [HOSPITAL] [COMPLETED]******************************')
    * print('******************** [PTRCR DETAILS] [COSMOS] [NON-PROD] [COMPLETED] *************************')
    # --- Validation and Report Generation ---
    * eval runValidation(Var)
    * print('[DONE] Scenario completed, validated, and cleaned:', Var)
  ...
  Scenario: 3. callonceing the Cosmos PTRCR Claim Details Physician
    ...
    * def calloncePayer = callonce read('classpath:feature_files/upm_ppkg/cosmos/PTRCR/non-prod/ppkg_nonprod_physician.feature')
