Feature:  HCP GQL - ALEX Claimserviceline
  ...
  Scenario: 1. Comparing the Cosmos HCP and ALEX Claim Details
    * print('******************** [HCP and ALEX Claim Details] [Claimservicelines] [STARTED] *********************')
    * def canonical = 'Claimservicelines'
    * print('******************** [PPKG Physician][STARTED] ******************************************')
    * def callonceHCP = callonce read('classpath:feature_files/ppkg_alex/hcp_mes_gql/claimServiceline/hcp_claimServiceline.feature')
    * print('******************** [PPKG Physician][COMPLETED] ****************************************')
    * print('******************** [ALEX Physician][STARTED] *******************************************')
    * def callonceALEX = callonce read('classpath:feature_files/ppkg_alex/hcp_mes_gql/claimServiceline/mes_claimServiceline.feature')
    ...
    * print('******************** [HCP and ALEX Claim Details] [Claimservicelines] [COMPLETED] *******************')
