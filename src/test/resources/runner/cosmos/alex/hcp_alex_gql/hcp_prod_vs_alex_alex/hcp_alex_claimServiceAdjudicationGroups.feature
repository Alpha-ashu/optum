Feature:  HCP GQL - Alex claimServiceAdjudicationGroups
  Scenario: 1. Comparing the Cosmos HCP and Alex Claim Details
    ...
    * def callonceHCP = callonce read('classpath:feature_files/ppkg_alex/hcp_alex_gql/claimServiceAdjudicationGroup/hcp_claimServiceAdjudicationGroup.feature')
    * print('******************** [HCP Physician][COMPLETED] ****************************************')
    * print('******************** [Alex Physician][STARTED] *******************************************')
    * def callonceAlex = callonce read('classpath:feature_files/ppkg_alex/hcp_alex_gql/claimServiceAdjudicationGroup/alex_claimServiceAdjudicationGroup.feature')
