Feature:  HCP GQL - Alex serviceAmbulances
  Scenario: 1. Comparing the Cosmos HCP and Alex Claim Details
    ...
    * def callonceHCP = callonce read('classpath:feature_files/ppkg_alex/hcp_alex_gql/serviceAmbulance/hcp_serviceAmbulance.feature')
    * print('******************** [HCP Physician][COMPLETED] ****************************************')
    * print('******************** [Alex Physician][STARTED] *******************************************')
    * def callonceAlex = callonce read('classpath:feature_files/ppkg_alex/hcp_alex_gql/serviceAmbulance/alex_serviceAmbulance.feature')
