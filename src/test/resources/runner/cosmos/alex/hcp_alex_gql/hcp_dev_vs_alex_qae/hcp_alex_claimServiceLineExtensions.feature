Feature:  HCP GQL - Alex claimServiceLineExtensions
  Scenario: 1. Comparing the Cosmos HCP and Alex Claim Details
    ...
    * def callonceHCP = callonce read('classpath:feature_files/ppkg_alex/hcp_alex_gql/hcp_dev_vs_alex_qae/claimServiceLineExtensions/hcp_claimServiceLineExtensions.feature')
