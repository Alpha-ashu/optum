Feature:  HCP GQL - Alex claimAccumulators
  Scenario: 1. Comparing the Cosmos HCP and Alex Claim Details
    ...
    * def callonceHCP = callonce read('classpath:feature_files/ppkg_alex/hcp_alex_gql/hcp_dev_vs_alex_qae/claimAccumulator/hcp_claimAccumulator.feature')
    * print('******************** [HCP Physician][COMPLETED] ****************************************')
    * print('******************** [Alex Physician][STARTED] *******************************************')
    * def callonceAlex = callonce read('classpath:feature_files/ppkg_alex/hcp_alex_gql/hcp_dev_vs_alex_qae/claimAccumulator/alex_claimAccumulator.feature')
