Feature: Request Cosmos VETSS PPKG PROD Summary Claim Details
  ...
  Scenario Outline: Request for PPKG Summary claim details validation
    ...
    * def perfData = { consumer: 'VETSS', feature: 'ppkg_summary', scenario: 'Request for PPKG Summary claim details validation', endpoint: '#(karate.info.scenarioName)', method: 'GET', status: '#(responseStatus)', responseTimeMs: '#(responseTime)' }
