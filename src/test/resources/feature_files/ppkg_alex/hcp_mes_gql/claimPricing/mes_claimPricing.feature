Feature: ALEX Claim Pricing GraphQL API Test
  ...
  Background:
    ...
    * def variables =
    ...
    """
  Scenario Outline: Send GraphQL request for Claim Pricing
    ...
    * def perfData = { consumer: 'ALEX', feature: 'mes_claimPricing', scenario: 'Send GraphQL request for Claim Pricing', endpoint: '#(karate.info.scenarioName)', method: 'POST', status: '#(responseStatus)', responseTimeMs: '#(responseTime)' }
