Feature: HCP Claim Other Payers GraphQL API Test
  ...
  Scenario Outline: Send GraphQL request for Claim Other Payers
    ...
    * def perfData = { consumer: 'ALEX', feature: 'hcp_claimOtherPayer', scenario: 'Send GraphQL request for Claim Other Payers', endpoint: '#(karate.info.scenarioName)', method: 'POST', status: '#(responseStatus)', responseTimeMs: '#(responseTime)' }
