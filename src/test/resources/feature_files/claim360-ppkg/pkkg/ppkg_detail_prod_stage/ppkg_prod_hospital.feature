Feature: Request Cosmos PayerPackage Non-PROD Claim Details
  ...
  Scenario Outline: Get PayerPackage claim Details to compare with Alex
    Given url 'https://api.uhg.com/api/clm/hist/claims360/1.0.0/claims/' + internalclaimindentifier
    ...
    * def filename = 'All_Responses/Hospital/PPKG_PROD_Detail_Responses/' + testcase + '_' + internalclaimindentifier + '_ppkgResponse.json'
