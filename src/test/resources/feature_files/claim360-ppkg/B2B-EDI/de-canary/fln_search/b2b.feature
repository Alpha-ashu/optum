...
"""
  Scenario Outline: Claims 360 B2B FLN Search
    ...
    * def filename = 'All_Responses/Claim360/B2B/FLN_Search/B2B_Responses/' + testcase + '_' + reqClmNbr + '_b2b.json'
    * def perfData = { consumer: 'CLAIMS360', feature: 'b2b_fln_search', scenario: 'Claim360 B2B FLN search request validation', endpoint: '#(karate.info.scenarioName)', method: 'POST', status: '#(responseStatus)', responseTimeMs: '#(responseTime)' }
